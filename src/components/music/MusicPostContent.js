...
export const musicPostContentList = [
  ...
  },
  {
    ...
    postText: [
      "One fateful day I opened YouTube on my phone and was suggested the video for Magdalena Bay's 'Dreamcatching'. The recommended video didn't have many views at the time, but I was intrigued by the thumbnail: a faun-esque woman's face stared back, surrounded by wisps of paint. I clicked play and my life is better for it.",
      "What unfolded was a spectacular journey through AI generated landscapes, accompanied by a dark yet driving melody-- in an effort to do the work proper justice, I've included it below for your personal viewing. From here I fell hard into the gravity of Magdalena Bay, 'Killshot' was my next view into this mercurial world, and from there I found more tracks I loved: 'Secrets', 'Chaeri', and 'You Lose!'.",
      "With each new track came a synth interpretation of another genre: 'Killshot' and 'Secrets' come off as quirky, funk throwaways, but 'Chaeri' is something of a digitized ballad, and 'You Lose!' sounds as though it could be from a remastered Yeah Yeah Yeahs or Silversun Pickups album.",
      "And that's exactly what's so exciting about Magdalena Bay: the diversity of sound. Imagining their range, combined with the guest features and skill that come with a more seasoned musical career, Mag Bay clearly have the potential to define pop for years to come.",
    ],
    postBonusVideo: "https://www.youtube.com/embed/dXLCHvRsgRQ ",
  },
];
/*
{
