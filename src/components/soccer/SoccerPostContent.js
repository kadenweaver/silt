...
import chelseaWomenChampions23 from "../../pictures/ChelseaWomenChampions.png";
...
export const soccerPreviewContentList = [
  {
    previewKey: 7,
    previewTitle: "Chelsea Ladies Complete Domestic Double",
    previewImage: chelseaWomenChampions23,
    previewImageOffset: "49",
    postType: "soccer",
    postDate: "Aug 06, 2023",
  },
  {
    previewKey: 6,
    previewTitle: "Potter Out and Lampard Returns",
    previewImage: chelseaLogo,
    previewImageOffset: "12",
    postType: "soccer",
    postDate: "Apr 18, 2023",
  },
  {
    previewKey: 5,
    previewTitle: "Potter In Desperate Need of a Turnaround",
    previewImage: graham,
  ...
  {
    previewKey: 4,
    previewTitle: "Chelsea Switch Managers and Hope for Better Days",
    previewImage: managers,
    previewImageOffset: "45",
    postType: "soccer",
  ...
  },
  {
    previewKey: 3,
    previewTitle:
      "Tough Bout with Real Madrid Brings End to Champions League Defense",
    previewImage: Kai,
  ...
  },
  {
    previewKey: 2,
    previewTitle:
      "The Blues Secure Season Opener Win Through Alonso, Pulisic, and Chalobah",
    previewImage: FirstMatch,
  ...
  },
  {
    previewKey: 1,
    previewTitle:
      "Chelsea Bests Resilient Villarreal To Win Season's First Silverware",
    previewImage: SuperCup,
  ...
  {
    previewKey: 0,
    previewTitle: "Chelsea Are European Champs!",
    previewImage: apChels,
...
export const soccerPostContentList = [
  {
    ...
    postDate: "May 31, 2021",
    textHeader:
      "The Blues write a new chapter in their legacy as European giants, meeting expectations based on massive summer signings",
    postImage: apChels,
    postText: [
  ...
  },
  {
    ...
    postDate: "Aug 17, 2021",
    textHeader:
      "Tuchel's Men Edged Past The EL Champions 6-5 On Penalties, Though The Side Appeared Polished And In Control",
    postImage: SuperCup,
    postText: [
  ...
  },
  {
    ...
    postDate: "Aug 18, 2021",
    textHeader:
      "Chelsea Took No Prisoners Against Palace, Scoring Two Before Half And Sealing The Win With A Third Soon After The Break",
  ...
  },
  {
    ...
    postDate: "Apr 13, 2022",
    textHeader:
      "Despite An Incredible Second Leg Victory, Chelsea CL Campaign Ended By Madrid Goal In Extra Time",
    postImage: Kai,
    postText: [
      "Pure heartbreak, anyways, has it been a while since I last blogged about Chelsea?",
      "It's tough to be mad at the current squad with everything that's happened to Chelsea in the past year. Our dream team fell apart with injuries to Reece James and Ben Chilwell, in fact, you can probably see where we lost hold of the prem shortly after they got injured.",
      "Then you have our defeat to Liverpool in the League Cup, losing our owner due to his part in the war in Ukraine, and now this tragic defeat. Chelsea players and fans alike seem to be relishing still in this last season before...well...who knows what will happen? There's plenty to celebrate despite the hard times.",
      "It's a mix of factors lifting Chelsea spirits, multiple reasons to stay hopeful that if just the right things happen, Chelsea might not only survive a change in ownership, but thrive through it.",
  ...
  },
  {
    ...
    postDate: "Sep 13, 2022",
    textHeader:
      "Loss In Zagreb Sees Thomas Tuchel Dismissed, Potter Becomes Most Expensive Manager of All Time",
    postImage: managers,
    postText: [
  ...
  },
  {
    ...
    textHeader:
      "Graham Potter's Fingerprint Barely Applied At Chelsea Before Manager Carousel Continues",
  ...
  },
  {
    postType: "soccer",
    postTitle:
      "Fantastic Chelsea Women Win FA Cup and Fourth Consecutive WSL Title",
    postDate: "Aug 06, 2023",
    textHeader:
      "Emma Hayes, Sam Kerr, and Exquisite Chelsea Side Show Why Chelsea is the Best Team in England",
    postImage: chelseaWomenChampions23,
    postText: [
      "Despite a hotly contested race for the championship, Chelsea were able to comfortably relegate Reading on the last day of the season, just beating out Manchester United for first place in the league by two points. The Red Devils were also Chelsea's victim in the FA Cup. Despite an impressive breakout season for the side, they were bested by Emma Hayes's team on both fronts.",
      "The season was so impressive for Chelsea that it may set a record for records, not to mention the legacies it set the team up to chase. The Blues' season marks a new high for both WSL wins (19) and points (58), with Chelsea making Kingsmeadow and Stamford Bridge (their collective home field) a fortress: the side won all eleven of their home games.",
      "I will personally remember this season as the first time I made a concerted effort to watch Chelsea's matches, notably in their later Champion's League ties. I'll never forget watching them battle for the comeback against Lyon in the quarterfinal, ultimately winning the tie on a penalty shootout save by Ann-Katrin Berger. That was a thriller of a match from a legendary Chelsea team!",
    ],
  },
];
